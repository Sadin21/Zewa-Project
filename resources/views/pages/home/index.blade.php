        ...
        <div class="position-absolute top-50 start-50 translate-middle text-center">
            ...
            <div class="bg-white mt-4 p-2 d-flex gap-3" style="width: 600px; border-radius: 4px;">
                <select class="form-select" aria-label="Default select example">
                    <option selected>Cari kategori produ</option>
...
<section class="" style="margin-top: 5rem;">
    ...
    <div class="row mt-4">
        <div class="col">
            <div class="card">
                <img src="{{ url('/assets/imgs/chair.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title poppins-medium fs-18">Kursi Hijau</h5>
                    <div class="my-3">
                        <p class="mb-0 poppins-regular fs-12">Harga sewa mulai dari</p>
                        <p class="mb-0 poppins-medium fs-14">Rp. 500.000</p>
                    </div>
                    <a href="#" class="btn poppins-medium text-white fs-14" style="background-color: #184A4B;">Lihat Detail</a>
                </div>
            </div>
    ...
    <div class="row mt-4">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title poppins-medium fs-18">Elektronik</h5>
                    <div class="my-3">
                        <p class="mb-0 poppins-regular fs-12">Total barang tersedia saat ini</p>
                        <p class="mb-0 poppins-medium fs-14">23 Unit</p>
                    </div>
