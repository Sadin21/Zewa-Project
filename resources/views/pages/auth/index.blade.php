    ...
    <div class="container">
        ...
        <div class="row mt-4">
            ...
            <div class="col pt-4 mt-4">
                ...
                <h6 class="poppins-medium medium-green fs-14">Mudah, Aman, Terpercaya</h6>
                <div class="" style="margin-top: 6rem;">
                    ...
                    <div class="text-center">
                        <button type="button" class="btn bg-medium-green poppins-medium text-white fs-14 w-100 py-2" style="background-color: #00A3A8;">Login</button>
